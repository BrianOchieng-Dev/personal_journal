...
<h1 className="text-slate-900 dark:text-white text-5xl lg:text-6xl font-black leading-tight tracking-tight">
                                Your Mind Deserves a <span className="text-primary">Private Space</span>
</h1>
<p className="text-slate-600 dark:text-slate-400 text-lg lg:text-xl font-normal leading-relaxed max-w-xl">
                                Capture your thoughts, track your personal growth, and find clarity in a secure digital sanctuary designed for your mental well-being.
                            </p>
</div>
...
<div 
  className="size-8 rounded-full border-2 border-background-light bg-slate-200" 
  style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAO_Fd-YJiU4fd8l660s_CyKL_MRMW8ZAmGCUQKXt4L7Q32KQgjvskdn0jwPeYGMqL4OOsr3poh1Z-lFBwCvs64tpbuRN58-v7NLFwakvXWebPL-y-obapyUN-U_dHH4X32MiOmEU3YbwgCgBo565dp02MjeCpavyHLi07DYuvcozQKsa3FWmSlWT2yYnw1rmIfhGgqva3J4hrZ0-pEtzEkK1B6jSFVVUnNxyDn3tkpbx3bYFQpIy-rYnahJCEkTdinzzi8B2fUxZyN')" }}
  aria-label="User avatar 1"
></div>

<div 
  className="size-8 rounded-full border-2 border-background-light bg-slate-300" 
  style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCr-rhD7hu3XNsHvRpFjYcjq9CvTDCaVyLykwO9XUMdtUow0WMfPfxnew5d9xbaqwhVhtBjts-BMa5RVCFe4p0w_HENPAfZpFAS-Os8vpnWABpfAtt0Agvucy40-BO02bbu0MQuk890AC4mulEAkiiHdIMf9fT7mML-2OyS432tK7pABd--18w2E1T1-BRCS9bQzK8P2UukBwmArtq8NT2CIt6Os9XSzVHV6V72BIlKta7mwrzPPXBEghrf2SbAT0KGEcsMODEc0QH3')" }}
  aria-label="User avatar 2"
></div>

<div 
  className="size-8 rounded-full border-2 border-background-light bg-slate-400" 
  style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuB6dmrAXQsIzv1P9--843IHwLRmVpM0N7XQcpnuh7-tpcehmIcjHVWEYKXxVc8vLggPWp_CjOGGO1Lov79gFtddFDavhaAi__NtfQt25DNf6SqiwQaC1v2gWwD_u0QigppKTSwrc_e3tHZjgsg1w4RwuAp-HW5o1CE9QmQg0BwltPYyn03y0cqZ0hBg50b3852I2F7oFytnqgVUQNI5ZBGW8A1ts3rscZ_4XfCNRKA2trnakg1oc9WMx1i-vKwqxon-cJDei7THZxxI')" }}
