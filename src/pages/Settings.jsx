                    ...
                    <header className="mb-12 flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-500 dark:text-slate-400 font-medium">Manage your private journaling experience.</p>
                            </div>
                        </div>
                    </header>

                    {/* Settings Navigation Tabs (Local to the page) */}
                    ...
                    <div className="space-y-8 h-full">
                        {activeTab === 'profile' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="flex flex-col md:flex-row items-center md:items-center gap-6 p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all hover:shadow-md">
                        ...
                        {activeTab === 'security' && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
                                    ...
                                    <button className="w-full h-14 border border-slate-200 dark:border-slate-700 rounded-2xl font-bold hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors uppercase text-xs tracking-widest">Change Vault Password</button>
                                </div>
                                ...
                                <div className="p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex flex-col gap-3">
                                            ...
                                            <select className="w-full bg-slate-50 dark:bg-slate-800 h-14 rounded-2xl px-5 border-none focus:ring-2 focus:ring-primary/20 outline-none font-bold text-sm appearance-none">
